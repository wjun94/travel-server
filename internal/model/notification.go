...
type Notification struct {
	...
	Type         int       `gorm:"default:1" json:"type"`        // 1搭子申请 2攻略点赞 3新增关注 4系统通知 5评论点赞 6搭子动态（解散/退出/补位）
	...
	CancelReason string    `gorm:"size:500" json:"cancelReason"` // 解散原因（type=6 搭子解散通知专用，可空）
